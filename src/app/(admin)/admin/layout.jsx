  ...
  return (
    <div className="flex min-h-screen flex-col bg-surface-alt">
      ...
      {scrivibile ? (
        ...
        <div className="flex flex-wrap items-center gap-x-2 gap-y-1 border-b border-red-200 bg-red-50 px-4 py-2.5 sm:px-5">
          <Icona misura="sm" nome="AlertTriangle" className="shrink-0 text-red-600" />
          <p className="text-piccolo font-medium leading-snug text-red-700">
      ...
      <div className="flex min-h-0 flex-1">
        {/* ------------------------------------------- colonna a sinistra */}
        <aside className="hidden w-[220px] shrink-0 flex-col bg-ink-900 lg:flex">
          <div className="px-5 pb-5 pt-6">
            <p className="text-corrente font-bold text-white">Amministrazione</p>
            <p className="text-mini text-white/50">Contenuti del sito</p>
          </div>
          ...
          <div className="border-t border-white/10 p-4">
            <Link
              href="/"
              data-comando
              className="inline-flex items-center gap-1.5 text-mini font-semibold text-white/50 hover:text-white"
            >
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center justify-between gap-3 bg-ink-900 px-4 pt-3 lg:hidden">
            <p className="text-corrente font-bold text-white">Amministrazione</p>
            <Link
              href="/"
              data-comando
