    ...
    <>
      ...
      <Sezione sfondo="bianco">
        <div className="grid gap-5 lg:grid-cols-2">
          {gruppi.map((g) => (
            <article key={g.titolo} className="rounded-[var(--radius-scheda)] border border-line bg-white p-6">
              <div className="flex items-center gap-3">
                ...
                >
                  <Icona misura="md" nome={g.icona} />
                </span>
                <h2 className="text-guida font-bold leading-tight">{g.titolo}</h2>
              </div>
              <p className="mt-4 text-corrente leading-relaxed text-ink-500">{g.testo}</p>
              <ul className="mt-5 space-y-2.5">
                {g.voci.map((v) => (
                  <li key={v} className="flex gap-2.5">
                    ...
                    />
                    <span className="text-piccolo leading-snug text-ink-600">{v}</span>
                  </li>
                ))}
              </ul>
            </article>
      ...
      <section className="bg-ink-900 py-14 lg:py-20">
        <Contenitore>
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-5 text-testo leading-relaxed text-ink-300">
          ...
          <div className="mx-auto mt-12 grid max-w-4xl gap-3 sm:grid-cols-4">
            {[
              ...
              <div key={c.n} className="rounded-[var(--radius-scheda)] border border-white/10 bg-white/5 p-5">
                <span className="flex size-9 items-center justify-center rounded-[var(--radius-controllo)] bg-brand-600/20 text-brand-300">
                  <Icona misura="sm" nome={c.icona} />
                </span>
                <p className="mt-4 text-corrente font-semibold">{c.t}</p>
                <p className="mt-1.5 text-piccolo leading-relaxed text-ink-300">{c.d}</p>
              </div>
            ))}
          </div>
        </Contenitore>
      ...
      <Sezione sfondo="alt">
        <div className="mx-auto max-w-3xl rounded-[var(--radius-scheda)] border border-line bg-white p-6">
          <h2 className="text-t2 font-bold">Quello che invece non prometto</h2>
          <p className="mt-4 text-corrente leading-relaxed text-ink-600">
